/********************************************************************************
** Form generated from reading UI file 'surfacestyle.ui'
**
...
#ifndef UI_SURFACESTYLE_H
#define UI_SURFACESTYLE_H
...
public:
    ...
    void setupUi(QWidget *SurfaceStyle)
    {
        if (SurfaceStyle->objectName().isEmpty())
            SurfaceStyle->setObjectName(QStringLiteral("SurfaceStyle"));
        SurfaceStyle->resize(641, 485);
        gridLayout = new QGridLayout(SurfaceStyle);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        widget_frame = new QWidget(SurfaceStyle);
...
"font-weight:bold;"));
        ...
        gridLayout->addWidget(widget_frame, 0, 0, 1, 1);


        retranslateUi(SurfaceStyle);

        QMetaObject::connectSlotsByName(SurfaceStyle);
    } // setupUi

    void retranslateUi(QWidget *SurfaceStyle)
    {
        SurfaceStyle->setWindowTitle(QApplication::translate("SurfaceStyle", "Form", 0));
        lab_Ico->setText(QString());
        lab_Title->setText(QApplication::translate("SurfaceStyle", "\346\210\221\347\232\204\346\222\255\346\224\276\345\231\250", 0));
#ifndef QT_NO_TOOLTIP
        btnMenu->setToolTip(QApplication::translate("SurfaceStyle", "\350\217\234\345\215\225", 0));
#endif // QT_NO_TOOLTIP
        btnMenu->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnMenu_Min->setToolTip(QApplication::translate("SurfaceStyle", "\346\234\200\345\260\217\345\214\226", 0));
#endif // QT_NO_TOOLTIP
        btnMenu_Min->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnMenu_Max->setToolTip(QApplication::translate("SurfaceStyle", "\346\234\200\345\244\247\345\214\226", 0));
#endif // QT_NO_TOOLTIP
        btnMenu_Max->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnMenu_Close->setToolTip(QApplication::translate("SurfaceStyle", "\345\205\263\351\227\255", 0));
#endif // QT_NO_TOOLTIP
...
namespace Ui {
    class SurfaceStyle: public Ui_SurfaceStyle {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SURFACESTYLE_H
